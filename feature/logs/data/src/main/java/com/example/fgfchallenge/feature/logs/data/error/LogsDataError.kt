...
/**
 * The single failure `LogsRepository` reports and the direct error bound of [Result]. Transport
 * exceptions, HTTP plumbing, and serialization types stop at the data boundary and are collapsed
 * into this value before presentation ever sees them.
 *
